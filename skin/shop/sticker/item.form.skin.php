...
add_stylesheet('<link rel="stylesheet" href="'.G5_SHOP_CSS_URL.'/general_enclosed_foundicons.css">', 1);
add_stylesheet('<link rel="stylesheet" href="'.G5_SHOP_CSS_URL.'/autofix_anything.css">', 2);
add_stylesheet('<link rel="stylesheet" href="'.G5_SHOP_CSS_URL.'/jquery.qtip.css">', 3);
$skin_url = G5_SKIN_URL.'/shop/'.$it['it_skin'];
?>
<script src="<?php echo $skin_url; ?>/jquery-ui-1.10.4.min.js"></script>
<script src="<?php echo $skin_url; ?>/jquery.autofix_anything.js"></script>
<script src="<?php echo $skin_url; ?>/jquery.qtip.min.js"></script>
...
<div id="sit_ov_wrap">
    ...
    <!-- 상품 요약정보 및 구매 시작 { -->
    <section id="sit_ov">
        <div id="header_move_stick" >
            <div class="fix_pos_box">
                <!-- 주문옵션 열기 시작 { -->
                <div class="order_container">
                    <div class="order_option_select">
                        <div class="sit_ov_header clear_box">
                            <button type="button" id="open_order_btn" class="open_order_btn" ><i class="foundicon-plus"></i></button><h2>주문옵션 열기</h2>
                            <div class="abs_move_order ">
                                선택한 옵션 <span id="abs_order_optioncnt" class="move_number">0</span><span>|</span>
                                총 금액 <span id="abs_order_totalprice" class="move_number">0</span> 원
                            </div>
                        </div>
                        <div class="sit_ov_body">
                ...
                <!-- } 주문옵션 열기 끝 -->
                <!-- 스티커 붙이기 -->
                <div class="fix_pos_stickers">
                    <h3>스티커 바로가기</h3>
                    <div class="sticker_fixed_header">
                        <div class="sticker_input_box">
                            <h4>원하는위치에 스티커를 붙일수 있습니다.</h4>
                            <button type="button" class="btn_append_sticker" onclick="ShopFixLayer.append_sticker();" /><i class="foundicon-plus"></i>스티커 붙이기</button>             					
                        </div>
                    </div>
                    <div id="bookmark_sticker_list" class="bookmark_sticker_list" style="display:none;">
                        <ul></ul>
                    </div>
                </div>
                <!-- //스티커 붙이기 -->
...
(function($){
    ...
    if($.browser.msie && parseFloat($.browser.version) < 8){
        loadCSS("<?php echo G5_SHOP_CSS_URL?>/general_enclosed_foundicons_ie7.css"); //ie7용 폰트 로드
    }
})(jQuery);
</script>