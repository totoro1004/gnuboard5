...
?>
<div id="poll_wrap">
	<button type="button" id="poll_toggle_btn" class="poll_toggle"><i class="fa fa-pie-chart" aria-hidden="true"></i><span class="sound_only">설문조사 열기</span></button>
	<div class="poll_div">		
		<!-- 설문조사 시작 { -->
		...
		<aside id="poll">
		    <h2>
		    	설문조사
		    	<?php if ($is_admin == "super") { ?><a href="<?php echo G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?php echo $po_id ?>" class="btn_admin btn"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">설문자 관리</span></a><?php } ?>
		    </h2>
		    <div class="poll_con">
			    ...
			    <div id="poll_btn">
			        ...
			        <a href="<?php echo G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn_result btn_poll">결과보기</a>
			    </div>
		    </div>
		</aside>
		</form>
