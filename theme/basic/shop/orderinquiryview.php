	                ...
	                <span>
	                    ...
	                    if($od['od_settle_case'] == '신용카드' || is_inicis_order_pay($od['od_settle_case']) || (shop_is_taxsave($od, true) && $misu_price == 0) )
	                    {
	                        if($od['od_pg'] == 'lg') {
                                ...
                                $card_receipt_script = 'window.open(\'https://npg.nicepay.co.kr/issue/IssueLoader.do?TID='.$od['od_tno'].'&type=0\', \'winrecipt\', \'width=400,height=500,scrollbars=yes,resizable=yes\');';
	                        } else {
