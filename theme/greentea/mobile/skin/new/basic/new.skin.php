...
<div class="list_03" id="new_list">
    ...
    <li>
    	...
    	<div class="newli_info">
        	<span class="sound_only">용량</span><span class="new_guest"><?php echo parseSize($list[$i]['wr_2']) ?></span>
        	...
        	<?php if($is_admin == "super") { ?><span class="sound_only">조회</span><span class="new_view"><i class="fa fa-eye" aria-hidden="true"></i> <?php echo $list[$i]['wr_hit'] ?></span><?php } ?>
        </div>
    </li>
    <?php } ?>
